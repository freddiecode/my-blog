...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/AAD.png?raw=true)
...
2. Select **Configure**.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/01.png?raw=true)

3. Select **Configure staging mode** and click **Next**.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/02.png?raw=true)

4. Log in with either your **Azure AD Global Administrator** or **Hybrid Identity Administrator** credentials and click **Next**.
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/03.png?raw=true)

5. Check **Enable stagning mode** and click **Next**.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/04.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/05.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/06.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/07.png?raw=true)

3. Select **Manage Azure AD cloud sync**, this will take you to the cloud sync configuration blade.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/08.png?raw=true)

4. Press **Download agent** on the top menu and start the download the pressing the **Accept terms & download** button. 
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/09.png?raw=true)
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/10.png?raw=true)

5. When the download is complete, run the installer. When prompted, agree to the terms and conditions and click **Install**.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/11.png?raw=true)

6. When the configuration wizard launches, click **Next** to continue.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/12.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/13.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/40.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/14.png?raw=true) 
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/15.png?raw=true)

11. Then the agent installation and configuration is completed, close the wizard by clicking **Exit**.
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/16.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/17.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/18.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/19.png?raw=true)
...
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/20.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/21.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/22.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/22_01.png?raw=true)
...
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/23.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/24.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/25.png?raw=true)
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/26.png?raw=true)
...
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/27.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/28.png?raw=true)

16. In the final **Deploy step**, when ready, click **Enable** and then click **Save** at the top of the page.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/29.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/31.png?raw=true)
2. Select **Microsoft Azure AD Connect** and click **Uninstall**.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/32.png?raw=true)
3. Leave the defaults and click **Remove**.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/33.png?raw=true)
4. Wait for the unistall to complete. When finished, click **Exit**.
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/34.png?raw=true)
...
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/38.png?raw=true)
- Powershell:
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/35.png?raw=true)
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/36.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/39.png?raw=true)
...
![img](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/30.png?raw=true)
...
![enter image description here](https://github.com/freddiecode/my-blog/blob/master/assets/images/AADCloudSync/37.png?raw=true)
